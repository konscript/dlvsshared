					...
					<tr>
						...
						<?php
							if (get_field("booking_url", $clinic->ID)){
								$button = '<a class="button-book iframe button-book-table" href="' . get_field('booking_url', $clinic->ID) . '"><div class="button-book-title">Book</div><img src="' . get_template_directory_uri() . '/img/icon-rightarrow-white.png" class="button-book-icon" /></a>';
							}else{
